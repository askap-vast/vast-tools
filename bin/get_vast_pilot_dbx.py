...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "Input an already generated list of available files"
            " for the script to use. If required,"
            " this file can be generated by the"
    ...
    parser.add_argument(
        '--download-threads',
        type=int,
        help='How many parallel downloads to attempt.',
        default=1)
