...
parser.add_argument('--img-folder', type=float, help='Path to folder where images are stored')
parser.add_argument('--cat-folder', type=float, help='Path to folder where selavy catalogues are stored')
